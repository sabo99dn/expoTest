...
import Navigation from '../utils/stackMethod';
...
function NotificationStack(props) {
  return (
    <Stack.Navigator initialRouteName="Notification" mode="card" headerMode="screen">
      <Stack.Screen
        name="Notification"
        component={Notifications}
        options={{
          header: ({ navigation, scene }) => (
            <Header title="Notification" navigation={navigation} scene={scene} />
          ),
          cardStyle: { backgroundColor: "#F8F9FE" }
        }}
      />
